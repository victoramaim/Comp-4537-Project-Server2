...
def generate_story(request):
    user_input = request.json.get('user_input', '')  # Use request.json.get() to avoid KeyError
    genre = request.json.get('genre', 'superhero')  # Default to superhero if genre is not provided
    if not user_input:
